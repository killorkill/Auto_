                ...
                <article class="article-item row">
                            ...
                            <div class="clearfix">
                                <div class="date-post">
                                    ...
                                    <span class="arrow-date">24</span>
                                    <span class="m-y">01 / 2022</span>
                                ...
                                <div class="article-main" data-num="tin-5">
                                    ...
                                    <h2 class="heading">MẮT BÃO YEAR END PARTY EM 20 | Enter - Explore - Enjoy </a></h2>
                                    ...
                                    <div class="article-content">
                                        ...
                                        <div class="excerpt">
                                            Ngày 18/01/2022 vừa qua chương trình Year End Party EM 20 | Enter - Explore - Enjoy đã diễn ra thành công cũng như để lại nhiều cảm xúc cho tập thể Công ty Cổ phần Mắt Bão.
                                        </div>

                                        <div class="text">
                                            <p style="box-sizing: border-box; margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: iCielPanton-Light; font-style: inherit; font-weight: inherit; background-color: rgb(249, 249, 249); font-size: 14px;">
	<span style="box-sizing: border-box; margin: 0px; padding: 0px; font-size: 16px;"><span style="box-sizing: border-box; margin: 0px; padding: 0px; font-family: &quot;times new roman&quot;, times, serif;"><strong>EM 20 | Enter - Explore - Enjoy</strong>&nbsp;là chương trình nằm trong chuỗi các hoạt động nội bộ của Mắt Bão tổ chức nhằm vinh danh những cá nhân xuất sắc nhất năm 2021 cũng như gắn kết các thành viên trong đại gia đình Mắt Bão.<br />
	<br />
	Với hình thức tổ chức online trên Microsoft Teams, các thành viên nhà Bão đã có cơ hội cùng nhau ngồi lại để ôn lại hành trình trong năm 2021. Ngoài ra, còn là dịp để vinh danh và khen thưởng những nhân viên xuất sắc nhất trong năm 2021 - những cá nhân đã cống hiến hết mình vì công việc với 3 hạng mục: Nhân viên xuất sắc, Quản lý xuất sắc và Best of The Best</span></span></p>
<span style="box-sizing: border-box; margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: iCielPanton-Light; background-color: rgb(249, 249, 249); font-size: 16px;"><span style="box-sizing: border-box; margin: 0px; padding: 0px; font-family: &quot;times new roman&quot;, times, serif;">​</span></span><br style="box-sizing: border-box; margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: iCielPanton-Light; font-size: 15px; background-color: rgb(249, 249, 249);" />
<p style="box-sizing: border-box; margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-family: iCielPanton-Light; font-style: inherit; font-weight: inherit; background-color: rgb(249, 249, 249); font-size: 14px;">
	<em style="box-sizing: border-box; margin: 0px; padding: 0px;"><span style="box-sizing: border-box; margin: 0px; padding: 0px; font-size: 16px;"><span style="box-sizing: border-box; margin: 0px; padding: 0px; font-family: &quot;times new roman&quot;, times, serif;">Cùng nhìn lại những khoảnh khắc đặc biệt của các thành viên Mắt Bão trong đêm Year End Party đáng nhớ này nào!<br />
	<br />
	<img alt="Thumbnail.jpg" src="https://matbao.com/getattachment/e6422d9f-7dc1-4ac3-838f-2335d3abdbea/Thumbnail.jpg.aspx?width=712&amp;height=400" style="width: 712px; height: 400px;" title="Thumbnail.jpg" /><br />
	<br />
	<img alt="MicrosoftTeams-image-(18).png" src="https://matbao.com/getattachment/7e7d29ea-4519-4bf5-87c5-855cbf605386/MicrosoftTeams-image-(18).png.aspx?width=712&amp;height=400" style="width: 712px; height: 400px;" title="MicrosoftTeams-image-(18).png" /><br />
	<br />
	<img alt="MicrosoftTeams-image-(21).png" src="https://matbao.com/getattachment/f58c7cd7-8564-4246-aae5-7604e3d696dc/MicrosoftTeams-image-(21).png.aspx" style="width: 712px; height: 400px;" title="MicrosoftTeams-image-(21).png" /><br />
	<br />
	<img alt="MicrosoftTeams-image-(1).png" src="https://matbao.com/getattachment/cf035677-2982-4ad4-9871-13e515d69b81/MicrosoftTeams-image-(1).png.aspx" style="width: 712px; height: 400px;" title="MicrosoftTeams-image-(1).png" /><br />
	<br />
	<img alt="MicrosoftTeams-image-(20).png" src="https://matbao.com/getattachment/8c5e37eb-b2ce-48fe-a185-c3b4f8122115/MicrosoftTeams-image-(20).png.aspx" style="width: 712px; height: 400px;" title="MicrosoftTeams-image-(20).png" /></span></span></em></p>
        ...
        <ul class="list-news-sidebar">
                    ...
                    <li>
                        <div class="wrap-thumbnail">
                            <a href="/Tin-tuc/Tin-tuc-cong-ty/Mat-Bao-tham-gia-toa-đam-ve-Online-Travel-Agency”.aspx" style="background:url('/getattachment/95d55700-74b6-4ee0-830f-a4092e136788/NodeAlias.aspx?width=90&height=60'); background-repeat: no-repeat; background-position: center;" class="thumbnail ratio-4-3"></a>
                        </div>
                        <h4 class="title"><a href="/Tin-tuc/Tin-tuc-cong-ty/Mat-Bao-tham-gia-toa-đam-ve-Online-Travel-Agency”.aspx">
                            Mắt Bão tham gia toạ đàm về “Online Travel Agency”
                        </a></h4>
                    </li>
                
                    <li>
                        <div class="wrap-thumbnail">
                            <a href="/Tin-tuc/Tin-tuc-cong-ty/Chuong-trinh-khuyen-mai-Đon-Giang-Sinh-cung-Mat-Ba.aspx" style="background:url('/getattachment/fea78c4c-5dca-4392-9a57-9a277c694e09/NodeAlias.aspx?width=90&height=60'); background-repeat: no-repeat; background-position: center;" class="thumbnail ratio-4-3"></a>
                        </div>
                        <h4 class="title"><a href="/Tin-tuc/Tin-tuc-cong-ty/Chuong-trinh-khuyen-mai-Đon-Giang-Sinh-cung-Mat-Ba.aspx">
                            Chương trình khuyến mãi "Đón Giáng Sinh cùng Mắt Bão"
                        </a></h4>
                    </li>
                
                    <li>
                        <div class="wrap-thumbnail">
                            <a href="/Tin-tuc/Tin-cong-nghe/QC-CLOUD-SERVER-SSD-CAM-KET-BOI-HOAN-MUA-NGAY-GIA.aspx" style="background:url('/getattachment/ce3ed513-2722-44fe-91a6-8c7f9fe1a3be/NodeAlias.aspx?width=90&height=60'); background-repeat: no-repeat; background-position: center;" class="thumbnail ratio-4-3"></a>
                        </div>
                        <h4 class="title"><a href="/Tin-tuc/Tin-cong-nghe/QC-CLOUD-SERVER-SSD-CAM-KET-BOI-HOAN-MUA-NGAY-GIA.aspx">
                            [QC] CLOUD SERVER SSD: CAM KẾT BỒI HOÀN - MUA NGAY GIÁ TỐT
                        </a></h4>
                    </li>
